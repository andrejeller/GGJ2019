...
public class Pvr_UnitySDKHeadTrack: MonoBehaviour {
    ...
    //private bool rotateControll = false;
    //private Quaternion rotatingWithControll;
    //public Quaternion Rotation { get { return rotatingWithControll; } set { rotatingWithControll = value; } }
    //public bool rotateWithControll { get { return rotateControll; } set { rotateControll = value; } }
    ...
    private void UpdateHead() {
        ...
        if (trackRotation) {
            ...
            //if (rotateControll)
               // rot = new Quaternion(rot.x, rotatingWithControll.y, rot.z, rotatingWithControll.w);
